...
var TRANSLATIONS = {
  en: {
    /* rediseño 2026-08 */
    "topbar_search_ph": "Search events…",
    "new_event": "New event",
    "overview": "Overview",
    "lib_root": "Library",
    "active_event": "Active event",
    "ev_eyebrow": "Portfolio",
    "panel_eyebrow": "Today",
    "an_eyebrow": "Insights",
    "lib_eyebrow": "Reusable",
    "countdown": "Countdown",
    ...
    "sync_hint_ok": "All changes saved to cloud.",
    "sync_hint_busy": "Syncing with cloud…",
    "sync_hint_offline": "Saved locally — will sync when reconnected.",
    "sync_hint_error": "Could not save — check connection.",
    "just_now": "just now",
    "min_ago": "{n} min ago",
  ...
  es: {
    /* rediseño 2026-08 */
    "topbar_search_ph": "Buscar eventos…",
    "new_event": "Nuevo evento",
    "overview": "Panel general",
    "lib_root": "Biblioteca",
    "active_event": "Evento activo",
    "ev_eyebrow": "Portafolio",
    "panel_eyebrow": "Hoy",
    "an_eyebrow": "Inteligencia",
    "lib_eyebrow": "Reutilizable",
    ...
    "sync_error": "Error al guardar",
    "sync_hint_ok": "Todos los cambios están en la nube.",
    "sync_hint_busy": "Sincronizando con la nube…",
    "sync_hint_offline": "Guardado localmente — se sincronizará al reconectar.",
    "sync_hint_error": "No se pudo guardar — revisa la conexión.",
